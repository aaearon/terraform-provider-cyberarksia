...
#
# IMPORTANT: GCP target format requirements:
# - projects: 3-60 chars, lowercase letters/numbers/hyphens, must start with letter, end with letter or number
# - vpc_ids: Full path format "projects/{project_id}/global/networks/{network_name}"
